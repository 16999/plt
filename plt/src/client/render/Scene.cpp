...
Scene::Scene(sf::RenderWindow& window) : window(window)
{
  ...
  this->playerSurface[0].initPlayer({"../res/tank"+to_string(this->currentState.getCurrentPlayer().getTankType())+".png","../res/turret0.png","../res/bullet0.png"});
  this->playerSurface[1].initPlayer({"../res/tank"+to_string(this->currentState.getAdversePlayer().getTankType())+".png","../res/turret0.png","../res/bullet0.png"});
}
